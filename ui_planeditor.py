...
class Ui_planEditor(object):
    def setupUi(self, planEditor):
        ...
        planEditor.setMaximumSize(QSize(1200, 700))
        ...
        self.verticalSpacer_7 = QSpacerItem(20, 17, QSizePolicy.Minimum, QSizePolicy.Expanding)
        ...
        font4.setBold(True)
        self.pushButton_add.setFont(font4)
        ...
        self.verticalSpacer_5 = QSpacerItem(20, 17, QSizePolicy.Minimum, QSizePolicy.Expanding)
        ...
        self.tableView.setMaximumSize(QSize(870, 250))
        self.tableView.setStyleSheet(u"background-color: rgb(249, 249, 249);")

        self.gridLayout.addWidget(self.tableView, 0, 2, 4, 1)
        ...
        self.pushButton_del.setFont(font4)
        ...
        self.gridLayout.addItem(self.verticalSpacer_3, 2, 0, 2, 1)
        ...
        self.gridLayout.addItem(self.horizontalSpacer_11, 3, 3, 1, 1)
